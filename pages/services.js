...
const Services = () => (
        <Layout>
            ...
            <div class=" my-0 box-border">
                ...
                <div class="mb-8 absolute  flex flex-col  ">
                    <h1 class="font-thin pb-4">Exploring.</h1>
                    <div className="gap-x-24  py-0 px-2 flex flex-wrap place-items-center items-center justify-center grid grid-cols-3 grid-flow-col ">

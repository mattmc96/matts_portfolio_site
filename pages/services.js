        ...
        <Layout>
            ...
            <div class="max-w-screen-lg my-0 mx-auto">
                <div class="py-0 px-2 flex flex-wrap place-items-center items-start justify-evenly grid grid-rows-3 grid-flow-col gap-0 gap-x-0">
                    ...
                    <div class="p-2 mb-3 w-1/2 sm:w-auto sm:px-1 sm:py-2 justify-center">
                ...
                <div>
                    <h1 class="font-thin">Exploring.</h1>
                    <div class="flex justify-evenly">

                    <div className="p-2 mb-3 w-1/2 sm:w-auto sm:px-1 sm:py-2">
                        <h2 className="mt-0 mr-0 mb-1 ml-0">TypeScript</h2>
                        <img className="transform motion-reduce:transform-none hover:-translate-y-1 hover:scale-105 transition ease-in-out duration-500"
                             width={100} height={100} src="/typescript-original.svg"/>
                    </div>
                    <div className="p-2 mb-3 w-1/2 sm:w-auto sm:px-1 sm:py-2">
                        <h2 className="mt-0 mr-0 mb-1 ml-0">Sequelize</h2>
                        <img className="transform motion-reduce:transform-none hover:-translate-y-1 hover:scale-105 transition ease-in-out duration-500"
                             width={100} height={100} src="/sequelize-original.svg"/>
                    </div>
                    <div className="p-2 mb-3 w-1/2 sm:w-auto sm:px-1 sm:py-2">
                        <h2 className="mt-0 mr-0 mb-1 ml-0">AWS</h2>
                        <img className="transform motion-reduce:transform-none hover:-translate-y-1 hover:scale-105 transition ease-in-out duration-500"
